...
public class LightSensorActivity35 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graphLight = initGraph(R.id.graph_light, "Light Sensor");
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_LIGHT:
                ...
                mSeriesLight.appendData(new DataPoint(graphLastAccelXValue,
                        sensorEvent.values[0]), true,33);
